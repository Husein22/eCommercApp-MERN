...
function CategoryPage() {
  ...
  {category && category.length > 0 ? category.charAt(0).toUpperCase() + category.slice(1).replace(/-/g, " ") : ''}
</h1>
            ...
            {productsSearch.length === 0 ? (
                <h1>Nema proizvoda za pokazati</h1>
            ) : (
                ...
                <Container>
                    <Row>
                        <Col md={{ span: 10, offset: 1 }}>
                            ...
                            {productsSearch.map(product=> <ProductPreview {...product}></ProductPreview>)}
